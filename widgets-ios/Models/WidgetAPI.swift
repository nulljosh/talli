...
struct WidgetAPI {
    ...
    private nonisolated(unsafe) static let defaults = UserDefaults(suiteName: "group.com.jt.talli")
    ...
    private static func cache(_ data: Data) {
        defaults?.set(data, forKey: "widget_summary")
        defaults?.set(Date().timeIntervalSince1970, forKey: "widget_summary_time")
    }
}
