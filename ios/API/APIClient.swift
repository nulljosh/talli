...
final class APIClient: @unchecked Sendable {
    ...
    func getReadMessages() async throws -> ReadMessages {
        try await send(path: "api/read-messages", responseType: ReadMessages.self)
    }

    func markMessagesRead(ids: [String]) async throws -> ReadMessages {
        try await send(
            path: "api/read-messages",
            method: "POST",
            body: ReadMessagesRequest(readIds: ids),
            responseType: ReadMessages.self
        )
    }
