...
## Changelog
- v3.5.8 (2026-07-22): Fixed What's New sheet bottom clipping — `presentationDetents` was sized from GeometryReader content height alone, missing the home-indicator safe-area inset the sheet still reserves, so the "Got it" button got cut off.
