...
struct MacPaymentCalendarView: View {
    ...
    private var displayMonth: Date { paymentDate ?? Date() }
                        ...
                        Text("\(day)")
                            ...
                            .background {
                                if cell.isPaymentDay {
                                    Circle().fill(Color.bcPrimary)
                                } else if cell.isToday {
                                    Circle().strokeBorder(Color.bcPrimary.opacity(0.4), lineWidth: 1)
                                }
                            }
